//Abhi iska kaam pura krna hai components me todna hai abhi header bas hua hai
...
function App(){
  ...
  const addStudent = ()=>{
    ...
    let exists = studentList.some(                //we check here when user give roll number and we find from student list ki kahin ye hai to nahi ye wala roll number
